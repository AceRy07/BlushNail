/* ============================================================
   ...
   Tum isletme bilgilerini bu dosyadan guncelleyin.
   ============================================================ */

const SITE_CONFIG = {
  business: {
    name: "Blush Nail Beauty",
    tagline: "Cankaya'da Profesyonel Tirnak ve Guzellik Salonu",
    location: "Ankara - Cankaya",
    whatsappNumber: "905419072141",
    ...
    address: "Kirkkonaklar, 329. Cadde 31/B, Cankaya / Ankara",
    phone: "+90 506 980 10 25",
    rating: 4.7,
    reviewCount: 67,
    hours: [
      { days: "Pzt - Cmt", time: "09:00 - 21:00" },
      { days: "Pazar", time: "13:00 - 18:00" },
    ],
  },
};